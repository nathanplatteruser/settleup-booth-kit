...
| QRs | Letter demo · GitHub repo · Pages home · walkthrough · demo screen | Calendly (PRIMARY) · SettleUp home · Book intro · Book Nathan · everything · risk-scan · qr · brainstorm · demo recall · waitlist |
| Sales CTAs | **None** (no Calendly, pricing, site marketing, waitlist, book-me) | **Yes** - book 20 min / Calendly. |
